...
Hello everyone. I am a Machine learning enthusiast. I am going to write a series in the machine learning. The interesting fact about the Machine Learning field is building a system which can operate on its own.
...
2. Technical example:
    ...
    Note: In the upcoming blogs I am going to explain the sales-specific scenario.